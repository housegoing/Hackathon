...
public class Publisher implements UserDetails {
    ...
    public Publisher(String firstName, String lastName, String email, String password,
            AppPublisherRole appPublisherRole) {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        SimpleGrantedAuthority authority = new SimpleGrantedAuthority((appPublisherRole.name()));
